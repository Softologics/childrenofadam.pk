...
export default function IndexAi(){
    ...
    return(
        <>
         <span className="fixed blur-[200px] lg:w-[600px] w-[400px] lg:h-[600px] h-[400px] rounded-full top-[10%] md:start-[10%] -start-[20%] bg-red-600/20"></span>
            ...
            <div className="relative grid lg:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                <div className="lg:col-span-7">
                    <div className="lg:me-6 lg:text-start text-center">
                        ...
                        wrapper="span"
                        speed={50}
                        className="typewrite bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"
                        repeat={Infinity}
                    />
                    </h1>
                        ...
                        <div className="subcribe-form mt-6 mb-3">
                            <form className="relative max-w-md mx-auto lg:ms-0">
                                ...
                                <button type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-red-600 hover:bg-red-700 border border-red-600 hover:border-red-700 text-white rounded-md">Sign Up</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-5">
                    <div className="relative after:content-[''] after:absolute lg:after:-top-0 after:-top-10 after:-right-32 after:w-[36rem] after:h-[36rem] after:border-2 after:border-dashed after:border-slate-200 dark:after:border-slate-700 after:rounded-full after:animate-[spin_120s_linear_infinite] after:-z-1 before:content-[''] before:absolute lg:before:-top-24 before:-top-36 before:-right-56 before:w-[48rem] before:h-[48rem] before:border-2 before:border-dashed before:border-slate-200 dark:before:border-slate-700 before:rounded-full before:animate-[spin_240s_linear_infinite] before:-z-1">
                        <div className="relative after:content-[''] after:absolute lg:after:-top-0 after:-top-10 after:-right-40 after:w-[36rem] after:h-[36rem] after:bg-gradient-to-tl after:to-red-600/30  after:from-red-600/30 dark:after:to-red-600/50 dark:after:from-red-600/50 after: after:blur-[200px] after:rounded-full after:-z-1">
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="grid md:grid-cols-3 grid-cols-1 shadow shadow-gray-300 dark:shadow-gray-500 rounded-lg md:divide-x-[1px] divide-y-[1px] divide-gray-200 dark:divide-gray-700">
                    <div className="relative p-6 md:p-8">
                        <i className="mdi mdi-account-search-outline bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text text-[45px]"></i>
                        ...
                        <MdKeyboardArrowRight className="h-8 w-8 p-1 bg-red-600 text-white rounded-full flex justify-center items-center absolute md:top-2/4 md:-translate-y-2/4 -bottom-4 md:-end-0 end-2/4 ltr:translate-x-2/4 rtl:-translate-x-2/4 rtl:rotate-180 z-1"/>
                    </div>

                    <div className="relative p-6 md:p-8">
                        <i className="mdi mdi-wallet-bifold-outline bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text text-[45px]"></i>
                    ...
                    <div className="relative p-6 md:p-8">
                        <i className="mdi mdi-home-plus-outline bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text text-[45px]"></i>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div className="relative overflow-hidden rounded-lg border border-red-600/40 bg-red-600/10 dark:bg-red-600/20 lg:ps-12 ps-8 lg:pt-12 pt-8 lg:me-8">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div className="relative order-1 md:order-2">
                        <div className="relative overflow-hidden rounded-lg border border-red-600/40 bg-red-600/10 dark:bg-red-600/20 lg:pe-12 pe-8 lg:pt-12 pt-8 lg:ms-8">
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px] relative">
                    <div className="lg:col-span-8 md:col-span-12">
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                ...
                                <span className="mdi mdi-flip-horizontal text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
        
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Plagiarism checker</Link>
                            ...
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                <span className="mdi mdi-email-edit-outline text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
        
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Content Generator</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            ...
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                <span className="mdi mdi-star-outline text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Search Engine Optimization</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            ...
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                <span className="mdi mdi-bookmark-outline text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Digital name generator</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div className="lg:col-span-4 md:col-span-12">
                        <div className="grid lg:grid-cols-1 md:grid-cols-2 grid-cols-1 gap-[30px]">
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                <span className="mdi mdi-account-check-outline text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Ad Targeting tips</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            ...
                            <div className="px-6 py-10 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 duration-500 rounded-lg hover:bg-white hover:dark:bg-slate-900">
                                <span className="mdi mdi-comment-multiple-outline text-4xl bg-gradient-to-tl to-red-600 from-red-600 text-transparent bg-clip-text"></span>
                                <div className="content mt-7">
                                    <Link href="/page-services" className="title h5 text-lg font-medium hover:text-red-600">Content Rewriter</Link>
                                    <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                        ...
                        <div className="slide-track flex items-center">
                            <div className="slide h-auto md:w-[360px] w-72 m-2">
                                <ul className="space-y-4">
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-red-600">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link href="#" className="text-lg hover:text-red-600 duration-500 ease-in-out">Thomas Israel</Link>
                                    ...
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-red-600">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link href="#" className="text-lg hover:text-red-600 duration-500 ease-in-out">Barbara McIntosh</Link>
                                                <p className="text-slate-400">User</p>
                                            </div>
                                        </div>
                                ...
                                <ul className="space-y-4">
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-red-600">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link href="#" className="text-lg hover:text-red-600 duration-500 ease-in-out">Carl Oliver</Link>
                                                <p className="text-slate-400">User</p>
                                            </div>
                                        </div>
                                    ...
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-red-600">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link href="#" className="text-lg hover:text-red-600 duration-500 ease-in-out">Jill Webb</Link>
                                                <p className="text-slate-400">User</p>
                                            </div>
                                        </div>
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-red-600">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            ...
                                            <div className="ps-4">
                                                <Link href="#" className="text-lg hover:text-red-600 duration-500 ease-in-out">Janisha Doll</Link>
                                                <p className="text-slate-400">User</p>
                                            </div>
                                        </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center md:gap-[30px]">
                    <div className="lg:col-span-4 md:mb-0 mb-8">
                        ...
                        <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-red-600 border-gray-100 dark:border-gray-800 hover:border-red-600 dark:hover:border-red-600 text-slate-900 dark:text-white hover:text-white rounded-full">Contact Us</Link>
                    </div>
                                ...
                                <div className="lg:flex items-center justify-between lg:w-2/4">
                                    ...
                                    <ul className="list-none text-slate-400 md:mb-0 mb-5">
                                        {item.features.map((el,index)=>{
                                            return(
                                                <li key={index} className="mb-1 flex items-center"><BsCheckCircle className="text-red-600 text-base me-2" /> {el}</li>
                                            )
                                        })}
                                    </ul>
                                </div>

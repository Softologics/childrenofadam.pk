            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 mt-10">
                     <div className="grid grid-cols-1 mt-10">
                         <h5 className="text-red-600 text-lg font-medium">Here to turn make hand turn</h5>
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                           ...
                           <div className="relative">
                               ...
                               <div className="absolute bottom-16 end-0">
                                   ...
                                   <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                        <Link href="#" onClick={() => setOpen(true)} data-type="youtube" data-id="S_CGed6E610" className="lightbox h-14 w-14 rounded-full shadow-lg inline-flex items-center justify-center bg-white text-red-600">
                       ...
                       <div className="md:col-span-7">
                           <div className="lg:ms-4">
                               <h5 className="font-medium text-lg text-red-600">Nice Top Series</h5>

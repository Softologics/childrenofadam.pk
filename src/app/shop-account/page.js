            ...
            <div className="container relative">
                ...
                <div className="relative mt-3">
                    <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                        ...
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-red-600"aria-current="page">My Account</li>
                    </ul>
                </div>
            </div>
        </section>
                                    ...
                                    <table className="w-full text-start text-slate-500 dark:text-slate-400">
                                        ...
                                        <tbody>
                                            <tr className="bg-white dark:bg-slate-900 text-start">
                                                ...
                                                <td className="px-2 py-3 text-start"><Link href="#" className="text-red-600 flex items-center">View <FaArrowRight className="ms-2 text-[10px]"/></Link></td>
                                            </tr>

        ...
        <div className={className}>
            <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                <div className="md:col-span-6">
                    <h6 className="text-red-600 text-sm font-bold uppercase mb-2">Blogs</h6>
                    ...
                    return(
                        <div className="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden" key={index}>
                            ...
                            <div className="content p-6">
                                <Link href={`/blog-detail/${data.id}`} className="title h5 text-lg font-medium hover:text-red-600 duration-500 ease-in-out">{data.title}</Link>

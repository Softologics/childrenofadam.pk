            ...
            <div className="sticky top-20">
                    ...
                    {RecentPostData.map((data, index) => {
                        return(
                            <div className="flex " key={index}>
                                ...
                                <div className="ms-3">
                                    <Link href="#" className="font-semibold hover:text-red-600">{data.Title}</Link>
                ...
                <ul className="list-none text-center mt-8">
                    {TagscloudItem.map((data,index) => {
                        return(
                            <li className="inline-block m-2" key={index}><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">{data.item}</Link></li>
                        )
                    }

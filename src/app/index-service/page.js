                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div className="md:col-span-7">
                        <div className="md:me-6">
                            <h4 className="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">Find the perfect <br /> <span className="text-red-600">Professional</span> for you</h4>
                            ...
                            <div className="subcribe-form z-1 mt-8">
                                <form className="relative mx-auto max-w-2xl">
                                    ...
                                    <button type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Search</button>
                                </form>
                    ...
                    {discoverData.map((item,index)=>{
                        ...
                        return(
                            <div key={index} className="group transition-all duration-500 ease-in-out text-center">
                                <div className="flex align-middle mx-auto justify-center items-center w-14 h-14 mt-1 bg-red-600/5 group-hover:bg-red-600 group-hover:text-white border-2 border-red-600/20 text-red-600 rounded-lg text-2xl shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">

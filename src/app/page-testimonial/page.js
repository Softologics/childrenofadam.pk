        ...
        <section className="relative md:py-24 py-16">
                                        ...
                                        <div className=" p-4 picture-item" key={index}>
                                            <div className="rounded-lg shadow dark:shadow-gray-800 p-6">
                                                <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                                    ...
                                                    <div className="ps-4">
                                                        <Link href = "#"className="text-lg hover:text-red-600 duration-500 ease-in-out">{data.name}</Link>
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 text-center">
                        ...
                        <div className="mt-6">
                            <Link href="/contact-one" className="py-2 px-5 inline-flex font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md mt-4"><FiPhone className="me-1 text-lg"/>  Contact us</Link>
                        </div>
                    </div>
                </div>
            </section>

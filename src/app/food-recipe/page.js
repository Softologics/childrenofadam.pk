                ...
                <div className="md:flex">
                    <div className="relative lg:w-2/3 w-full -mt-32">
                        <div className="px-6 py-12 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800 text-center">
                            <Link href="#" className="bg-red-600/10 text-red-600 font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5">Food & Recipes</Link>
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div>
                            <Link href="#" className="bg-red-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5 me-1">Food</Link>
                            <Link href="#" className="bg-red-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5 me-1">Drinks</Link>
                            <Link href="#" className="bg-red-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5 me-1">Recipes</Link>
                    ...
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="sticky top-20">
                            ...
                            <div className="text-center mt-8">
                                ...
                                <Link href="#" className="text-lg font-semibold hover:text-red-600 transition-all duration-500 ease-in-out">Cristina Romsey</Link>
                            ...
                            <ul className="list-none text-center mt-8 space-x-1">
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Food</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Chicken</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Recipe</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Enjoy</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Restra</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Sunday</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Offer</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Holiday</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Cake</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-red-600 dark:hover:bg-red-600 rounded-md shadow dark:shadow-gray-800 transition-all duration-500 ease-in-out">Burns</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>

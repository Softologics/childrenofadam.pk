                        ...
                        <div className="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                            ...
                            <div className="p-6">
                                <div className="flex justify-between pb-4">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly id="noti1" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly  checked id="noti2" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly id="noti3" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" readOnly type="checkbox"  id="noti4" />
                        ...
                        <div className="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                            ...
                            <div className="p-6">
                                <div className="flex justify-between pb-4">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly id="noti5" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly  id="noti6" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly  checked id="noti7" />
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-300 focus:ring focus:ring-offset-0 focus:ring-red-200 focus:ring-opacity-50" type="checkbox" readOnly  checked id="noti8" />

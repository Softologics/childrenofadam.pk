        ...
        <section className="relative table w-full py-36 lg:py-44 bg-gray-50 dark:bg-slate-800">
            <div className="container relative">
                <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div className="md:col-span-7 md:order-2 order-1">
                        <div className="ms-6">
                            <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">Stand Out With a Custom <span className="text-red-600">Phone Number</span></h4>
                            ...
                            <div className="subcribe-form mt-6">
                                <form className="relative max-w-xl">
                                    ...
                                    <button type="submit" className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-full"><LuSearch className='me-1'/> Find Number</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                    ...
                    <li className="inline  uppercase text-[13px] font-bold duration-500 ease-in-out text-red-600" aria-current="page">Phone Number</li>
                </ul>
            </div>
        </section>
                        ...
                        mobileNumber.map((data,index) => {
                            return (
                                <div key={index} className="group p-4 text-center rounded-lg shadow hover:shadow-lg dark:shadow-gray-800 transition duration-500">
                                    <Link href="#" className="hover:text-red-600 text-xl font-semibold">{data.number}</Link>

                                    <div className="mt-3 flex items-center justify-center">
                                        <span className="text-red-600 text-lg">{data.money}</span>
                                        <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-full ms-3">Buy Now</Link>
                                    </div>
                                </div>
                            )
                        })

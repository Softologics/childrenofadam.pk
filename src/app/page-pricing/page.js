                ...
                <div className="grid grid-cols-1">
                    <ul className="inline-block w-fit mx-auto flex-wrap justify-center text-center p-2 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full">
                        <li role="presentation" className="inline-block">
                            <button onClick={() => handleTabClick(0)} className={`${isOpenTab === 0 ?'text-white bg-red-600 hover:text-white' : ''} px-4 py-1 text-sm font-semibold rounded-full w-full hover:text-red-600 transition-all duration-500 ease-in-out`}>Monthly</button>
                        </li>
                        <li role="presentation" className="inline-block">
                        ...
                        {isOpenTab === 0 ?
                            <div>
                                <div className="grid lg:grid-cols-4 md:grid-cols-2 mt-8 gap-[30px]">
                                    <div className="group border-b-[3px] dark:border-gray-700 p-6 py-8 hover:border-red-600 dark:hover:border-red-600 transition-all duration-500 ease-in-out hover:scale-105 relative overflow-hidden shadow dark:shadow-gray-800 rounded-md bg-gray-50 dark:bg-slate-800 hover:bg-white dark:hover:bg-slate-900 h-fit">
                                    ...
                                    <div className="group border-b-[3px] border-red-600 p-6 py-8 transition-all duration-500 ease-in-out hover:scale-105 relative overflow-hidden shadow dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
                                    ...
                                    <div className="group border-b-[3px] dark:border-gray-700 p-6 py-8 hover:border-red-600 dark:hover:border-red-600 transition-all duration-500 ease-in-out hover:scale-105 relative overflow-hidden shadow dark:shadow-gray-800 rounded-md bg-gray-50 dark:bg-slate-800 hover:bg-white dark:hover:bg-slate-900 h-fit">
                                        ...
                                        <ul className="list-none text-slate-400">
                                            ...
                                            <li className="mb-1 flex items-center"><BsCheckCircle className="text-red-600 text-base me-2"/> Free Appointments</li>
                                            <li className="mb-1 flex items-center"><BsCheckCircle className="text-red-600 text-base me-2"/> Enhanced Security</li>
                                            <li className="mb-1 flex items-center"><BsCheckCircle className="text-red-600 text-base me-2"/> Free Installment</li>
                                        </ul>

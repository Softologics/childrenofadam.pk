                            ...
                            <form action="user-profile">
                                <div className="grid grid-cols-1">
                                    <div className="mb-4">
                                        ...
                                        <input id="LoginPassword" type="password" className="form-input mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" required="" placeholder="Password:" />
                                    </div>

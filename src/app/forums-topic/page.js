        ...
        <section className="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-red-600"><Link href="/index-forums">Forum</Link></li>
                    <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight className="text-xl"/></li>
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-red-600"aria-current="page">Techwind Announcements</li>
                </ul>
            </div>
        </section>
                                        ...
                                        return(
                                            <tr className="border-b border-gray-100 dark:border-slate-800" key={index}>
                                                <th className="text-start p-4">
                                                    <div className="flex">
                                                        <FaRegComments className="text-red-600 text-2xl"/>
                                                        <div className="ms-2">
                                                            <Link href="/forums-comments" className="hover:text-red-600 text-lg">{item.title}</Link>
                                                            <p className="text-slate-400 font-normal">Write by: <Link href="#" className="text-red-600">{item.name}</Link></p>
                                                        </div>
                                                    </div>
                                                </th>

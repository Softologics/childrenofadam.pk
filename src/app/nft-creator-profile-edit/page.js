...
export default function CreatoreProfileEdit(){
    ...
    return(
        ...
        <section className="relative table w-full py-32 lg:py-40 bg-gradient-to-br to-orange-600/20 via-fuchsia-600/20 from-red-600/20">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-flex items-center space-x-1">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-red-600"><Link href="/index-nft">NFT</Link></li>
                    <li className="inline-block text-base mx-0.5 ltr:rotate-0 rtl:rotate-180"><MdKeyboardArrowRight className="text-xl"/></li>
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-red-600" aria-current="page">Settings</li>
                </ul>
            </div>
        </section>
                    ...
                    <div className="lg:col-span-9 md:col-span-8">
                            ...
                            <form>
                                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Last Name:" id="lastname" name="name" required="" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input name="name" id="occupation" type="text" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Occupation :" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1">
                                    <div className="mt-5">
                                        ...
                                        <textarea name="comments" id="comments" className="form-input w-full text-[15px] py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Message :"></textarea>
                                    </div>
                                </div>
                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                            ...
                            <div className="flex justify-between pb-4">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" id="noti1" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" defaultChecked id="noti2" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" id="noti3" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" id="noti4" />
                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                            ...
                            <div className="flex justify-between pb-4">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" id="noti5" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" id="noti6" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" defaultChecked id="noti7" />
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div className="">
                                    <input className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-red-600 focus:border-red-600/30 focus:ring focus:ring-offset-0 focus:ring-red-600/20 focus:ring-opacity-50" type="checkbox" value="" defaultChecked id="noti8" />
                                    ...
                                    <form>
                                        <div className="grid grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <input name="number" id="number" type="number" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Phone :" />
                                            </div>

                                            <div>
                                                <label className="form-label font-medium">Website :</label>
                                                <input name="url" id="url" type="url" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Url :" />
                                            </div>
                                        </div>
                                    ...
                                    <form>
                                        <div className="grid grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Old password" required="" />
                                            </div>

                                            <div>
                                                <label className="form-label font-medium">New password :</label>
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="New password" required="" />
                                            </div>

                                            <div>
                                                <label className="form-label font-medium">Re-type New password :</label>
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0 mt-2" placeholder="Re-type New password" required="" />
                                            </div>
                                        </div>

...
export default function LandingFive(){
    ...
    return(
        ...
        <section className="relative py-40 lg:h-screen flex justify-center items-center bg-red-600/10 overflow-hidden" id="home">
            <div className="container relative">
                <div className="grid lg:grid-cols-12 md:grid-cols-2 gap-[30px] mt-10 items-center">
                    <div className="lg:col-span-7">
                        <div className="md:text-start text-center">
                            <h1 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">Resources for <span className="text-red-600">makers &</span> <br /> <span className="text-red-600">Creative</span> to learn & grow</h1>

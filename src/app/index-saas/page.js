...
export default function IndexSaas(){
    ...
    return(
        <>
            ...
            <section className="relative before:content-[''] before:absolute xl:before:-top-[30%] lg:before:-top-[50%] sm:before:-top-[80%] before:-top-[90%] before:-start-80 before:end-0 before:w-[140rem] before:h-[65rem] ltr:before:-rotate-12 rtl:before:rotate-12 before:bg-red-600/5 dark:before:bg-red-600/10 before:z-1 items-center overflow-hidden">
                <div className="container relative z-2">
                    <div className="grid grid-cols-1 md:mt-44 mt-32 text-center">
                        <div className="wow animate__animated animate__fadeIn">
                            ...
                            <div className="mt-6">
                                <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Try For Free</Link>
                    ...
                    <div className="bg-red-600 w-8 h-16 z-2 absolute start-2 lg:bottom-28 md:bottom-36 sm:bottom-40 bottom-16"></div>
                    <div className="bg-red-600/20 w-8 h-16 z-2 absolute start-12 lg:bottom-32 md:bottom-40 sm:bottom-44 bottom-20"></div>

                    <div className="bg-red-600/20 w-8 h-16 z-2 absolute end-12 xl:bottom-[420px] lg:bottom-[315px] md:bottom-[285px] sm:bottom-80 bottom-32"></div>
                    <div className="bg-red-600 w-8 h-16 z-2 absolute end-2 xl:bottom-[440px] lg:bottom-[335px] md:bottom-[305px] sm:bottom-[340px] bottom-36"></div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                        ...
                        <div className="lg:ms-8 wow animate__animated animate__fadeInRight" data-wow-delay=".3s">
                            ...
                            <ul className="list-none text-slate-400 mt-4">
                                <li className="mb-1 flex"><BsCheckCircle className="text-red-600 text-base me-2"/><i ></i> Digital Marketing Solutions for Tomorrow</li>
                                <li className="mb-1 flex"><BsCheckCircle className="text-red-600 text-base me-2"/><i ></i> Our Talented & Experienced Marketing Agency</li>
                                <li className="mb-1 flex"><BsCheckCircle className="text-red-600 text-base me-2"/><i ></i> Create your own skin to match your brand</li>
                            </ul>

    ...
    return (
        <>
                        ...
                        <div className="md:flex justify-center fixed top-2/4 -translate-y-2/4 ltr:md:-translate-x-2/4 rtl:md:translate-x-2/4 md:start-2/4 start-3 md:end-auto end-3 m-auto">
                            <div className="max-w-[400px] w-full bg-white dark:bg-slate-900 rounded-md shadow-xl dark:shadow-gray-800 px-6 py-8">
                                ...
                                <form>
                                    ...
                                    <button type="submit" id="submit" name="send" className="py-2 px-5 font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md w-full justify-center flex items-center">Send Message</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div className="fixed bottom-3 end-3">
                <Link href="#" className="back-button h-9 w-9 inline-flex items-center justify-center tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-full"><Icon.ArrowLeft className="h-4 w-4"></Icon.ArrowLeft></Link>
            </div>
        </>
    )
}

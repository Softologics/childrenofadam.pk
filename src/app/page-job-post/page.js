                            ...
                            <form className="text-start">
                                ...
                                <div className="grid grid-cols-12 gap-4 mt-4">
                                    <div className="col-span-12 text-start">
                                        ...
                                        <input id="RegisterName" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Web Developer" />
                                    </div>

                                    <div className="col-span-12 text-start">
                                        <label htmlFor="comments" className="font-semibold">Job Description:</label>
                                        <textarea name="comments" id="comments" className="form-input mt-2 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Write Job Description :"></textarea>
                                    </div>
                                    ...
                                    <div className="md:col-span-3 col-span-12 text-start">
                                        ...
                                        <div className="relative mt-1">
                                            <span className="absolute top-0.5 start-0.5 w-9 h-9 text-xl bg-gray-100 dark:bg-slate-800 inline-flex justify-center items-center text-dark dark:text-white rounded">
                                                <i className="mdi mdi-currency-usd text-red-600"></i>
                                            </span>
                                            <input type="number" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Min" name="minsalary" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="md:col-span-3 col-span-12 text-start">
                                        ...
                                        <div className="relative mt-1">
                                            ...
                                            <input type="number" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Max" name="maxsalary" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-12 gap-4 mt-4">
                                    <div className="col-span-12 text-start">
                                        ...
                                        <input id="Skillname" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Web Developer" />
                                    </div>

                                    <div className="md:col-span-6 col-span-12 text-start">
                                        <label className="font-semibold" htmlFor="Qualificationname">Qualifications:</label>
                                        <input id="Qualificationname" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Qualifications" />
                                    </div>

                                    <div className="md:col-span-6 col-span-12 text-start">
                                        <label className="font-semibold" htmlFor="Experiencename">Experience:</label>
                                        <input id="Experiencename" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Experience" />
                                    </div>
                                ...
                                <div className="grid grid-cols-12 gap-4 mt-4">
                                    <div className="col-span-12 text-start">
                                        ...
                                        <input id="Address" type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-red-600 dark:border-gray-800 dark:focus:border-red-600 focus:ring-0" placeholder="Address" />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 mt-4">
                                    <div>
                                        <button type="submit" id="submit" name="send" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white">Post Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>

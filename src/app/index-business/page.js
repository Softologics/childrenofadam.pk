...
export default function Business(){
    ...
    return(
                            ...
                            <div className="container relative z-3 flex items-center justify-center">
                                <div className="grid grid-cols-1 mt-10">
                                    <div className="text-center">
                                        ...
                                        <div className="mt-8">
                                            <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">See Services</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="container relative z-3">
                                <div className="grid grid-cols-1 mt-10">
                                    <div className="md:text-end text-center">
                                        ...
                                        <div className="mt-8">
                                            <Link href="#" className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Pricing Plans</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section className="relative py-8 bg-red-600">
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    <h6 className="text-red-600 text-sm font-bold uppercase mb-2">Who We Are ?</h6>
                    ...
                    {aboutData.map((item,index)=>{
                        ...
                        return(
                            <div className="group text-center" key={index}>
                                <Icons className="h-10 w-10 stroke-1 group-hover:stroke-[1.5px] group-hover:text-red-600 transition-all duration-500 ease-in-out mx-auto"/>
                                <div className="mt-6">
                                    <Link href="#" className="text-xl font-semibold group-hover:text-red-600 transition-all duration-500 ease-in-out">Profitable Marketing</Link>
            ...
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                    {PricingData.map((item,index)=>{
                        return(
                            <div key={index} className="group border-b-[3px] dark:border-gray-700 hover:border-red-600 dark:hover:border-red-600 transition-all duration-500 ease-in-out hover:scale-105 relative shadow dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900">
                                <div className="p-6 py-8">
                                    <h6 className="font-bold uppercase mb-5 text-red-600">{item.title}</h6>
                                    ...
                                    <ul className="list-none text-slate-400">
                                        {item.subData.map((el,index)=>{
                                            return(
                                                <li className="mb-1 flex" key={index}><BsCheckCircle className="text-red-600 text-base me-2"/>{el}</li>
                                            )
                                        })}
